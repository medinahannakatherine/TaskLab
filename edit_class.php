...
// Retrieve the class schedule data for the given ID
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $ref_table = "schedule";
  $data = array();
...
// Update the class schedule data if the form is submitted
    ...
    <div class="row h-100">
      ...
      <main class="col-lg-8 ml-md-auto px-4 offset-lg-1 mb-5">
        <div class="d-flex justify-content-center mt-5">
          <h1>Edit Class Schedule Entry</h1>
        </div>
        <div class="rounded p-5 pinkbgcolor mt-4" style="width: 80%">
          ...
          <form method="post">
            ...
            <div class="input">
              <input class="input-field" type="text" name="course_code" value="<?php echo $row['course_code']; ?>"
                required>
              <label class="input-label" for="course_code">Course Code:</label>
            </div>

            <div class="input">
              <input class="input-field" type="text" name="course_title" value="<?php echo $row['course_title']; ?>"
                required>
              <label class="input-label" for="course_title">Course Title:</label>
            </div>
            ...
            <div class="input">
              <input class="input-field" type="text" name="room" value="<?php echo $row['room']; ?>" required><br>
              <label class="input-label" for="room">Room:</label>
            </div>

            <div class="input">
              <input class="input-field" type="text" name="section" value="<?php echo $row['section']; ?>" required><br>
              <label class="input-label" for="section">Section:</label>
            </div>

            <div class="input-box">
              <label for="start_time">Start Time:</label>
              <input type="time" name="start_time" value="<?php echo $row['start_time']; ?>" required><br>
            </div>

            <div class="input-box">
              <label for="end_time">End Time:</label>
              <input type="time" name="end_time" value="<?php echo $row['end_time']; ?>" required><br>
            </div>
            ...
            <div class="action">
              <button class="action-button"><a href="manage_class.php">Back to Schedule</a></button>
            </div>
